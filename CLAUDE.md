...
**Open / optional (see ROADMAP.md):** WhatsApp/Telegram delivery; Claude-API cloud version (make the *automatic* digest Claude-grade); evening edition in the cloud; verify a Resend domain to email the redacted address.
