...
## Regulatory - FDA (US)
- **2026-06-18** · Tebipenem HBr (Spero/GSK) - FDA decision expected; oral antibiotic for complicated UTIs.
- **~2026-06-20** · Cytisinicline (smoking cessation) - FDA decision expected; watch approval vs. CRL.
- **~2026-06-30** · FDA PreCheck pilot - first ~7-participant manufacturing cohort selected; Lilly expected to file Foundayo (oral orforglipron) NDA around end-June.
...
- **Monthly (~3rd week)** · EMA CHMP meeting - positive/negative opinions on EU marketing authorisations; European Commission decisions typically follow ~1-2 months later.
- *Add specific CHMP opinions, EC approvals, and MHRA/PMDA decisions as they're scheduled.*

## Policy / macro
- **2026-07-31** · 100% branded-pharma tariff takes effect for large firms (0% for MFN + onshoring signatories). Major supply-chain and pricing catalyst.

## Earnings
- **Late Jul - early Aug 2026** · Q2 2026 earnings season (Lilly typically reports early August; Novo, Pfizer, AZ, Merck around the same window).

## Conferences / data readouts
- **Sep 2026** · EASD (European diabetes) - GLP-1 / metabolic data.
- **Oct 2026** · ESMO Congress - major oncology readouts.
- **Dec 2026** · ASH - hematology/oncology data.
...
- **2026-08-25** · Gland Pharma 48th AGM (auto-detected 2026-08-24)
...
- **2028-12-31** · Brukinsa access program ends (auto-detected 2026-08-20)
