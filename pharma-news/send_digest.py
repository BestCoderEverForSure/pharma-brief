...
# --- Markets: same tickers + fetch as the website (pharma_render), rendered email-safe
#     here (inline styles, no JS/CSS classes) so the email carries the site's strip too. ---
